...
# Si la correlación es positiva y cercana a 1, significa que a medida que aumenta la edad, también aumentan las impresiones. Si la correlación es negativa y cercana a -1, significa que a medida que aumenta la edad, disminuyen las impresiones. Si la correlación es cercana a 0, significa que no hay una relación clara entre las dos variables.
